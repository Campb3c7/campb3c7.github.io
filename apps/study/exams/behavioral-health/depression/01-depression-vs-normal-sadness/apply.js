addQuestions([
  ...
  {
    "q": "A patient grieving a parent reports wishing to be reunited but has no intent to die. What is the best action?",
    "choices": [
      "Ignore the statement because it is grief",
      "Assess suicide risk directly despite the grief context",
      "Diagnose MDD automatically",
      "Start an MAOI"
    ],
    "correct": 1,
    "explain": "Thoughts of reunion can occur in grief, but any death-related thoughts still warrant direct safety assessment."
  }
]);
