addQuestions([
  {
    ...
    choices: ["No — the bladder cancer patient is stage III, while the colon cancer patient is stage II, because staging criteria differ between cancer types even for identical TNM combinations", "Yes — the same TNM combination always corresponds to the same overall stage regardless of cancer type", "This cannot be determined without knowing the patients' ages", "No — both are actually stage IV, since T3 always indicates the worst stage"],
    correct: 0,
  ...
  },
  {
    ...
    choices: ["The summary staging system exclusively (in situ, localized, regional, distant)", "Brain tumors are never staged", "Cell type and grade", "A modified TNM system unique to only brain tumors but still called TNM"],
    correct: 2,
  ...
  },
  {
    ...
    choices: ["NX and MX, since lymph node biopsy does not count as evaluation", "N0 and M0, since regional lymph node involvement does not count toward staging", "N0 and M1", "N1 (or higher, reflecting regional lymph node involvement) and M0 (no distant metastasis)"],
    correct: 3,
