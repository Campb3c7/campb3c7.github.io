addQuestions([
  {
    ...
    choices: ["This step is used only to calculate her chemotherapy dosing", "Precise positioning is only required for brachytherapy, not external-beam radiation", "The positioning is only for the patient's comfort and has no bearing on treatment accuracy", "Simulation requires the patient to be in the exact same position for every treatment session, since detailed imaging is used to precisely map the tumor and surrounding normal tissue relative to the treatment machine"],
    correct: 3,
  ...
  },
  {
    ...
    choices: ["The margin is included purely to increase the total radiation dose for no clinical reason", "The margin accounts for tumor movement between treatments (e.g., from breathing) and reduces the risk of recurrence from microscopic cancer cells that may have spread into the adjacent normal tissue", "This is a technical error, and only the visible tumor should ever be targeted", "This practice is unique to brachytherapy and would not apply to external-beam radiation"],
    correct: 1,
  ...
  },
  {
    ...
    choices: ["Brachytherapy may deliver higher radiation doses to the prostate than external-beam therapy while causing less damage to surrounding normal tissue, and the implanted seeds will decay completely over a period of weeks to months", "Brachytherapy requires daily treatment sessions over several weeks, identical to external-beam therapy", "Brachytherapy always delivers a lower total dose than external-beam therapy and causes more normal tissue damage", "The implanted radioactive seeds will continue emitting radiation indefinitely and must eventually be surgically removed"],
    correct: 0,
  ...
  },
  {
    ...
    choices: ["Simulation-based radiation planning", "Systemic radiation therapy", "Brachytherapy", "External-beam radiation therapy"],
    correct: 1,
