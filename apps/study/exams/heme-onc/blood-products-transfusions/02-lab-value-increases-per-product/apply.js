addQuestions([
  {
    ...
    choices: ["~10.5 g/dL", "~7.5 g/dL", "6.5 g/dL (no change)", "~8.5 g/dL"],
    correct: 3,
  ...
  },
  {
    ...
    choices: ["This confirms a hemolytic transfusion reaction has occurred", "This confirms she has von Willebrand disease", "This suggests platelet refractoriness, and further evaluation for immune (HLA alloimmunization) or non-immune causes (sepsis, DIC, splenomegaly, certain medications) should be considered", "This is a completely normal, expected response and no further evaluation is needed"],
    correct: 2,
  ...
  },
  {
    ...
    choices: ["4 units; approximately 20%", "1 unit is always sufficient regardless of severity", "10 units; approximately 50%", "1 unit; ~20%"],
    correct: 0,
  ...
  },
  {
    ...
    choices: ["The Hgb was checked too late to be meaningful", "Something is preventing the expected rise — consider ongoing occult hemolysis/bleeding, dilution, or a transfusion reaction impairing the response, and investigate further", "PRBC transfusions never reliably raise Hgb, so no correlation should be expected", "This is an entirely expected response with no further workup needed"],
    correct: 1,
