addQuestions([
  {
    ...
    choices: ["Yes, transfuse — his cardiovascular disease lowers his threshold to 10 g/dL and he is below it", "No, transfusion is never indicated in pneumonia regardless of Hgb", "Yes, transfuse — all patients with any cardiovascular history should be kept above 10 g/dL", "No, do not transfuse — with preexisting cardiovascular disease his threshold is ≤ 8 g/dL, and his Hgb of 8.3 is above that"],
    correct: 3,
  ...
  },
  {
    ...
    choices: ["No — ACS patients should never be transfused regardless of Hgb", "No — her Hgb is above the general trigger of 7 g/dL", "Yes — but only if her platelet count is also low", "Yes — patients with ACS/MI have a threshold of < 10 g/dL, and her Hgb of 9.2 falls below this"],
    correct: 3,
  ...
  },
  {
    ...
    choices: ["No, but only platelets should be given, not PRBCs", "Yes, withhold transfusion since his Hgb is normal", "No — severely hemorrhaging trauma patients should be transfused based on clinically estimated blood loss, since the Hgb drop lags behind the actual bleeding event and may not yet reflect ongoing hemorrhage", "Yes, but only after his Hgb definitively drops below 7 g/dL"],
    correct: 2,
  ...
  },
  {
    ...
    choices: ["Yes — but only if she is also actively bleeding", "No — platelets are never given prophylactically in fever", "Yes — in the setting of fever/sepsis, the threshold rises to < 20,000, and her count of 15,000 falls below this", "No — her count of 15,000 is above the 10,000 threshold for spontaneous bleeding prevention"],
    correct: 2,
  ...
  },
  {
    ...
    choices: ["Yes — but only if he develops fever first", "No — his count is above the 10,000 threshold", "No — LP has no platelet threshold requirement", "Yes — invasive procedures like LP require a threshold of < 50,000, and his count of 45,000 falls below this"],
    correct: 3,
  ...
  },
  {
    ...
    choices: ["It can be checked now; expect an increase to approximately 12.5 g/dL", "It should be checked in 24 hours; expect no change", "It should never be rechecked after PRBC transfusion", "It can be checked now, at 15 minutes post-transfusion; expect an increase to approximately 8.5 g/dL (about 1 g/dL per unit)"],
    correct: 3,
