addQuestions([
  {
    ...
    choices: [
      "TRALI; treat with IV fluids and vasopressors",
      "TACO; treat with diuretics (e.g., furosemide 20-40 mg IV) after stopping the transfusion",
      "AHTR; treat with normal saline at 100-200 mL/hr",
  ...
  },
  {
    ...
    choices: [
      "TACO; diuretics are first-line and would help",
      "TRALI; diuretics would not effectively treat this noncardiogenic process and could worsen her existing hypotension",
      "FNHTR; diuretics are not indicated but also not harmful",
      "AHTR; diuretics would treat the underlying hemolysis"
    ],
    correct: 1,
  ...
  },
  {
    ...
    choices: [
      "Hypotension, normal BNP, and onset within 1-2 hours of transfusion start",
      "Hypertension, elevated BNP, JVD, and S3 gallop",
      "Bilateral diffuse infiltrates with no cardiac exam findings",
      "History of septic shock and mechanical ventilation"
    ],
    correct: 1,
  ...
  },
  {
    ...
    choices: [
      "Transfuse all 3 units simultaneously as quickly as possible to correct anemia rapidly",
      "Transfuse one unit at a reduced rate and assess his response before giving additional units, considering prophylactic diuresis given his high-risk status",
      "Avoid transfusion entirely regardless of symptoms",
      "Give all 3 units with no monitoring since dialysis will remove excess volume"
    ],
    correct: 1,
  ...
  },
  {
    ...
    choices: [
      "Definitive TRALI, since all the criteria for hypoxemia and imaging are met",
      "Possible TRALI, since the patient has an alternative risk factor for ARDS (pneumonia) that could also explain the findings",
      "TACO, since any pulmonary edema after transfusion is TACO by definition",
      "This cannot be a transfusion reaction since the patient has a preexisting lung infection"
    ],
    correct: 1,
