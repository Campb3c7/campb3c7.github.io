addQuestions([
  {
    ...
    choices: ["Type A positive, because it is the most common type", "Any type is equally safe in an emergency", "Type O negative, because O has no RBC surface antigens (safe from any recipient's antibodies) and negative Rh avoids sensitizing an Rh-negative recipient", "Type AB positive, because AB is the universal receiver"],
    correct: 2,
  ...
  },
  {
    ...
    choices: ["Rh compatibility is the only thing that matters for plasma, not ABO", "Type A plasma is always safe for any recipient", "Plasma transfusion never requires ABO matching", "Type A plasma contains anti-B antibodies which could react with any B antigens the recipient might encounter; ABO compatibility must still be verified for plasma, though AB recipients can technically accept plasma from AB donors specifically since they have no antigens to react with any plasma antibody type — in the most urgent scenario, Type AB or Type O plasma (compatible with all recipients) would be preferred over assuming 'close enough'"],
    correct: 3,
  ...
  },
  {
    ...
    choices: ["It's not actually true — Type O can receive any plasma type", "This has nothing to do with antigens or antibodies", "The logic flips between RBCs and plasma: Type O RBCs have no antigens (safe to give to anyone), but Type O recipients have anti-A and anti-B antibodies in their own plasma and no antigens on their RBCs, so they can only safely receive plasma from a donor without antibodies that could attack red cells they don't even have — meaning O is actually the universal PLASMA RECIPIENT, not a restricted recipient", "Type O blood is simply incompatible with all other types"],
    correct: 2,
  ...
  },
  {
    ...
    choices: ["There is no concern, since Rh antibodies are naturally present and cause no harm", "This scenario is impossible since Rh-negative individuals cannot receive Rh-positive blood under any circumstance", "ABO incompatibility poses a greater risk to the fetus than Rh sensitization", "She likely developed anti-D antibodies from her prior Rh-positive exposure (since D antigen exposure is highly immunogenic, unlike natural ABO antibodies), placing this and future Rh-positive pregnancies at risk for hemolytic disease of the newborn"],
    correct: 3,
