addQuestions([
  {
    ...
    choices: [
      "IgG antibodies against the antigens they possess",
      "IgM isoantibodies (isoagglutinins) against the missing antigen(s)",
      "No antibodies at all",
      "IgA antibodies against Rh antigens"
    ],
    correct: 1,
  ...
  },
  {
    ...
    choices: [
      "Yes, naturally, like ABO antibodies",
      "No — but exposure to the D antigen is highly immunogenic and will trigger antibody formation",
      "Yes, but only in females",
      "No, and exposure never triggers antibody formation"
    ],
    correct: 1,
  ...
  },
  {
    ...
    choices: [
      "Plasma/FFP, because they have no RBC antigens",
      "PRBCs, because they have no antibodies in plasma to react against any donor RBC antigen",
      "Platelets, because they lack HLA antigens",
      "Cryoprecipitate, because they lack fibrinogen"
    ],
    correct: 1,
  ...
  },
  {
    ...
    choices: [
      "Plasma/FFP, because they have no antibodies",
      "PRBCs, because they have no antigens on the RBC surface to trigger a reaction in any recipient",
      "Platelets, because they lack ABO antigens",
  ...
  },
  {
    ...
    choices: [
      "Type O, because it lacks antigens",
      "Type AB, because AB patients have no antibodies in their plasma to attack a recipient's RBCs",
      "Type A, because it has only anti-B antibodies",
      "Type B, because it has only anti-A antibodies"
    ],
    correct: 1,
  ...
  },
  {
    ...
    choices: [
      ...
      "Type O, because O recipients have no antigens on their RBCs for donor plasma antibodies to react against",
      "Type A, because it has anti-B antibodies only",
      "Type B, because it has anti-A antibodies only"
    ],
    correct: 1,
  ...
  },
  {
    ...
    choices: [
      "Yes, always, just like PRBCs",
      "No — Rh compatibility is not necessary for plasma",
      "Only for Rh-negative recipients",
      "Only for Rh-positive donors"
    ],
    correct: 1,
  ...
  },
  {
    ...
    choices: ["A and O only", "A, B, and O", "A and AB only", "All types"],
    correct: 0,
  ...
  },
  {
    ...
    choices: ["A and O only", "A and AB only", "O only", "All types"],
    correct: 1,
  ...
  },
  {
    ...
    choices: [
      "Have no immune response, since Rh is not immunogenic",
      "Create anti-D antibodies, since exposure to the D antigen is highly immunogenic",
      "Immediately develop anaphylaxis",
      "Automatically become Rh-positive permanently"
    ],
    correct: 1,
