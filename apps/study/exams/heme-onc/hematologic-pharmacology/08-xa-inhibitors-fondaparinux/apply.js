addQuestions([
  {
    ...
    choices: ["Any of the three oral factor Xa inhibitors would be equally appropriate in ESRD", "Apixaban — it is the DOAC of choice in ESRD, unlike rivaroxaban and edoxaban, which are contraindicated in severe renal impairment (GFR <30, or CrCl <15 for edoxaban)", "Edoxaban — it is specifically designed for use in dialysis patients", "Rivaroxaban — it is preferred in ESRD due to its once-daily dosing"],
    correct: 1,
  ...
  },
  {
    ...
    choices: ["His renal function is irrelevant to edoxaban dosing, which is fixed regardless of CrCl", "Edoxaban cannot be used for CrCl >95 — his supra-normal renal clearance is actually a contraindication for this specific drug, unlike the other DOACs, so an alternative agent should be selected", "His excellent renal function makes edoxaban an ideal, low-risk choice with no dosing concerns", "Edoxaban should be dosed at the reduced 30 mg dose given his high CrCl"],
    correct: 1,
  ...
  },
  {
    ...
    choices: ["Any anticoagulant is appropriate in HIT with no special selection considerations", "Unfractionated heparin at a lower dose — it remains appropriate despite the HIT diagnosis", "Fondaparinux — its niche use is bridging a patient to warfarin in HIT, since it does not cross-react with the heparin-dependent antibodies driving the thrombocytopenia", "Enoxaparin — since it is a different heparin formulation, it will not cross-react with her antibodies"],
    correct: 2,
  ...
  },
  {
    ...
    choices: ["Apixaban is contraindicated entirely given his combination of age, weight, and renal function", "5 mg twice daily — the standard dose, since dose reduction only applies if all 3 criteria plus additional factors are present", "10 mg twice daily — a loading dose is required given his advanced age", "2.5 mg twice daily — he meets 3 of the dose-reduction criteria (age ≥80, weight ≤60 kg, and creatinine ≥1.5 mg/dL), well above the threshold of 2 or more criteria required for dose reduction"],
    correct: 3,
