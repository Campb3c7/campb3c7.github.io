addQuestions([
  {
    ...
    choices: ["No — the threshold for line insertion is >80,000, so this count is inadequate", "No — the threshold for any invasive procedure is >100,000, so this count is inadequate", "The platelet count is irrelevant to line insertion risk", "Yes — the threshold for central venous line insertion/invasive procedures is >50,000, and this patient's count of 65,000 exceeds that threshold"],
    correct: 3,
  ...
  },
  {
    ...
    choices: ["No — major surgery or CNS procedures require a platelet count >100,000, and this patient's count of 75,000 falls short; platelet transfusion or count correction should be considered before proceeding", "Yes — major surgery only requires >10,000, the baseline threshold for spontaneous bleeding prevention", "The platelet count threshold for major surgery is identical to that for minor surgery", "Yes — 75,000 exceeds the >50,000 threshold, which is sufficient for major surgery"],
    correct: 0,
  ...
  },
  {
    ...
    choices: ["The sepsis-specific threshold of >20,000 is the only relevant consideration, and since her count is close to that, anticoagulation can proceed", "Platelet count has no bearing on the decision to start anticoagulation", "The threshold for administering an anticoagulant is >50,000 — this patient's count of 15,000 is well below that threshold, and starting anticoagulation should be deferred or reconsidered given the bleeding risk, independent of the separate >20,000 threshold that applies to preventing spontaneous bleeding in sepsis specifically", "The threshold for anticoagulant administration is >10,000, so this count is adequate to proceed"],
    correct: 2,
