addQuestions([
  {
    ...
    choices: ["He has developed a hemoglobinopathy", "He has developed polycythemia vera acutely", "This must represent a lab error requiring immediate repeat testing only", "His H&H is falsely elevated due to decreased plasma volume from dehydration, not a true increase in RBC mass — H&H should be interpreted cautiously since it reflects concentration, not absolute amount"],
    correct: 3,
  ...
  },
  {
    ...
    choices: ["Hyperthyroidism", "Dehydration", "Simple iron deficiency anemia", "A bone marrow process, given the pancytopenia (all three cell lines low) rather than an isolated anemia"],
    correct: 3,
  ...
  },
  {
    ...
    choices: ["This reasoning is flawed; a normal ferritin always rules out iron deficiency", "Ferritin is never useful in inflammatory conditions and should be ignored entirely", "Ferritin is an acute phase reactant that can be falsely elevated by inflammation, potentially masking a true underlying iron deficiency — a 'normal' ferritin in this context doesn't rule out iron deficiency", "Ferritin only reflects folate stores, not iron"],
    correct: 2,
  ...
  },
  {
    ...
    choices: ["No, serum folate is always accurate and needs no further action", "Yes — in situations where folate deficiency is expected, such as pregnancy, empiric folic acid supplementation is a reasonable standard approach without necessarily pursuing the more valid but rarely-ordered RBC folate level", "No, RBC folate must always be confirmed before any supplementation", "Yes, but only after a bone marrow biopsy"],
    correct: 1,
  ...
  },
  {
    ...
    choices: ["Hemoglobin electrophoresis; sickle cell disease", "SPEP/UPEP; multiple myeloma, a plasma cell malignancy most common in adults 50s and older", "TSH; hypothyroidism", "DAT; autoimmune hemolytic anemia"],
    correct: 1,
  ...
  },
  {
    ...
    choices: ["SPEP/UPEP", "Serum folate level", "TSH", "A (corrected) reticulocyte count, since it is not included in a standard CBC and must be specifically ordered to assess bone marrow response"],
    correct: 3,
