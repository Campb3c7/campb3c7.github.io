addQuestions([
  {
    ...
    choices: ["These findings confirm iron deficiency anemia; order iron studies next", "These findings are inconclusive and require no further workup", "These findings confirm liver disease; order an abdominal ultrasound next", "These findings confirm the hemolysis triad; order a direct antiglobulin test (DAT/Coombs) to determine whether this is immune-mediated hemolysis"],
    correct: 3,
  ...
  },
  {
    ...
    choices: ["This result is unrelated to the mechanism of hemolysis", "This confirms an immune-mediated process — the patient is producing an antibody against her own RBCs, consistent with autoimmune hemolytic anemia", "This confirms she has G6PD deficiency", "This confirms a mechanical cause of hemolysis, like a prosthetic heart valve"],
    correct: 1,
  ...
  },
  {
    ...
    choices: ["The negative DAT is expected and consistent with a non-immune (mechanical) mechanism of hemolysis from shear stress across the prosthetic valve, rather than an antibody-mediated process", "The DAT result is unrelated to hemolysis mechanism and should be ignored", "The negative DAT means he does not actually have hemolysis", "A negative DAT always indicates iron deficiency"],
    correct: 0,
  ...
  },
  {
    ...
    choices: ["The full hemolysis triad has not been met (LDH and haptoglobin are normal), so hemolysis has not yet been confirmed — ordering a DAT at this point is premature, and a liver cause for the isolated bilirubin elevation should be considered first", "This patient definitely has hemolysis and the DAT will confirm the mechanism", "DAT is only used for anemia workup, never for bilirubin abnormalities", "There is no issue; DAT should always be ordered for any bilirubin elevation"],
    correct: 0,
