addQuestions([
  ...
  },
  {
    ...
    choices: ["This indicates acute blood loss requiring transfusion", "This indicates hemolysis; order a DAT", "This is a normal finding requiring no further evaluation", "This corrected retic count < 2% indicates hypoproliferation — an inadequate marrow response — suggesting either an underlying bone marrow problem or a nutrient deficiency (iron, B12, folate); workup should focus on these areas rather than assuming ongoing blood loss or hemolysis"],
    correct: 3,
  ...
  },
  {
    ...
    choices: ["The raw value is always sufficient and correction is unnecessary", "Correction only matters for mild anemia, not severe anemia", "The raw retic count and corrected retic count are always identical", "Because the raw reticulocyte percentage depends on the degree of anemia, a severely low Hct like hers requires a markedly elevated raw retic count just to represent a truly adequate marrow response — the correction accounts for this, and her true corrected value may actually reveal inadequate compensation despite the seemingly high raw number"],
    correct: 3,
  ...
  },
  {
    ...
    choices: ["High corrected retic always means bone marrow failure", "High corrected retic = marrow is responding appropriately to a peripheral problem (hemolysis/blood loss); low corrected retic = the problem lies with the marrow itself or its nutrient supply", "Low corrected retic always means active hemolysis", "The corrected retic count cannot distinguish between any anemia categories"],
    correct: 1,
