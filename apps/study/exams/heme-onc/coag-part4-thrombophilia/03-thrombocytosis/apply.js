addQuestions([
  {
    ...
    choices: [
      "Treat with iron supplementation and recheck a CBC in approximately 8 weeks",
      "Immediate hematology consult and bone marrow biopsy",
      "Immediate platelet apheresis given the elevated count",
      "Start low-dose aspirin and hospitalize for observation"
    ],
    correct: 0,
  ...
  },
  {
    ...
    choices: [
      "Repeat the platelet count, obtain a peripheral smear, and check serum ferritin, CRP, and ESR to look for an occult reactive cause",
      "Immediately diagnose essential thrombocythemia and start cytoreductive therapy",
      "No further workup is needed since he is asymptomatic",
      "Immediate bone marrow biopsy without any further labs"
    ],
    correct: 0,
  ...
  },
  {
    ...
    choices: [
      "Refer to hematology; a bone marrow biopsy is likely needed to evaluate for an autonomous (myeloproliferative) process",
      "Reassure her that thrombocytosis without symptoms never requires further workup",
      "Start iron supplementation empirically",
      "Discharge with no follow-up since the smear is normal"
    ],
    correct: 0,
  ...
  },
  {
    ...
    choices: [
      "Hospitalize, treat the acute thrombosis per stroke protocol, and consult hematology to consider platelet apheresis given the count is above 800,000",
      "Discharge home with outpatient hematology follow-up in 2 weeks",
      "Start low-dose aspirin as monotherapy and observe as an outpatient",
      "No specific hematologic intervention is needed since stroke management is unrelated to platelet count"
    ],
    correct: 0,
  ...
  },
  {
    ...
    choices: [
      "Begin low-dose aspirin, hospitalize, and consult hematology",
      "Discharge with no treatment since there is no bleeding or thrombosis",
      "Immediate platelet apheresis since her count is elevated",
      "Full-dose therapeutic anticoagulation with a DOAC"
    ],
    correct: 0,
