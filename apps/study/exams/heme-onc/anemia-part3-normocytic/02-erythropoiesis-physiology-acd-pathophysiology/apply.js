addQuestions([
  {
    ...
    choices: ["Her bone marrow has become fibrotic due to her RA", "Her RA has caused a folate deficiency, which is the sole driver of her anemia", "She has developed an absolute iron deficiency from dietary insufficiency unrelated to her RA", "Chronic inflammation is driving elevated IL-6, which increases hepatic hepcidin production; hepcidin degrades ferroportin, trapping iron in macrophages and creating a functional iron deficiency that impairs erythropoiesis"],
    correct: 3,
  ...
  },
  {
    ...
    choices: ["ACD never causes any decline in MCV, so this must be iron deficiency", "An MCV below 80 always definitively excludes ACD as a contributing factor", "ACD typically trends mildly microcytic over time but usually does not dip much below ~80 fL — while not impossible, a value this low should prompt evaluation for a concurrent absolute iron deficiency rather than assuming ACD alone explains it", "MCV is irrelevant to distinguishing ACD from iron deficiency"],
    correct: 2,
  ...
  },
  {
    ...
    choices: ["This occurs because dietary iron intake has stopped completely", "Hepcidin degrades ferroportin, the transporter needed to export iron out of macrophages into the plasma — so iron accumulates and is trapped inside macrophages even though total body iron stores are adequate or even elevated", "Erythroid precursors have lost their transferrin receptor 1 in ACD, independent of iron availability", "The macrophages and erythroid precursors are actually experiencing identical iron levels, and the premise is false"],
    correct: 1,
