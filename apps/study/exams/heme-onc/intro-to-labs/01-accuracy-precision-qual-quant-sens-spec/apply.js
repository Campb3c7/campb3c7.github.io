addQuestions([
  ...
  },
  {
    ...
    choices: ["A quantitative abnormality, since platelet number is being assessed", "A qualitative abnormality, since platelet function is being assessed", "Both qualitative and quantitative", "Neither — this is a sensitivity issue"],
    correct: 1,
  ...
  },
  {
    ...
    choices: [
      "Specificity, to avoid treating anyone who does not have TB",
      "Sensitivity, to avoid missing anyone who might have TB",
      "Precision, so repeat tests always agree",
      "Accuracy, so the test matches the true prevalence"
    ],
    correct: 1,
  ...
  },
  {
    ...
    choices: [
      "Reassure the family — a negative sensitive test rules out disease",
      "Send a confirmatory throat culture, because an 85% sensitivity means false negatives are common enough to miss true cases",
      "Repeat the rapid strep test immediately for confirmation",
      "Start empiric antibiotics regardless of the result"
    ],
    correct: 1,
  ...
  },
  {
    ...
    choices: ["Sensitivity", "Specificity", "Accuracy", "Qualitative performance"],
    correct: 2,
