addQuestions([
  {
    ...
    choices: ["Average Neutrophil Calculation", "Absolute Nucleated Cells", "Active Neutrophil Concentration", "Absolute Neutrophil Count"],
    correct: 3,
  ...
  },
  {
    ...
    choices: ["Total WBC × (% bands + % segs)", "Total WBC × % lymphocytes", "Total WBC − (% bands + % segs)", "Total WBC ÷ (% bands + % segs)"],
    correct: 0,
  ...
  },
  {
    ...
    choices: ["Cells per mm3 exactly as reported", "The number in thousands", "The number in millions", "A percentage"],
    correct: 1,
  ...
  },
  {
    ...
    choices: ["5,000 cells/mm3", "1,500 cells/mm3", "250 cells/mm3", "2,500 cells/mm3"],
    correct: 3,
  ...
  },
  {
    ...
    choices: ["5,000 cells/mm3", "10,000 cells/mm3", "650 cells/mm3", "6,500 cells/mm3"],
    correct: 3,
    explain: "ANC = 10 × (0.05 + 0.60) = 10 × 0.65 = 6,500 cells/mm3."
  },
  {
    q: "What is the normal reference range for ANC?",
    choices: ["500 – 4,000 cells/mm3", "140,000 – 400,000 cells/mm3", "1,500 – 8,000 cells/mm3", "4,000 – 10,000 cells/mm3"],
    correct: 2,
    explain: "The normal ANC range is 1,500 – 8,000 cells/mm3."
  },
  {
    q: "Neutrophilia (elevated ANC > 8,000 cells/mm3) is most commonly due to:",
    choices: ["Vitamin B12 deficiency", "Viral infection", "Infection (commonly bacterial) or noninfectious inflammation", "Chemotherapy"],
    correct: 2,
  ...
  },
  {
    ...
    choices: ["Determine whether it is safe to give chemotherapy", "Diagnose viral hepatitis", "Monitor warfarin therapy", "Diagnose iron deficiency anemia"],
    correct: 0,
  ...
  },
  {
    ...
    choices: ["High risk", "No risk", "Moderate risk", "Fairly low risk"],
    correct: 3,
  ...
  },
  {
    ...
    choices: ["Fairly low risk", "Normal, no risk", "High risk", "Moderate risk"],
    correct: 3,
  ...
  },
  {
    ...
    choices: ["Fairly low risk", "Normal, no risk", "Moderate risk", "High risk"],
    correct: 3,
