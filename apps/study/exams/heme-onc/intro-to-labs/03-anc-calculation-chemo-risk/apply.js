addQuestions([
  {
    ...
    choices: ["ANC = 1,240; moderate risk; consider delaying chemotherapy", "ANC = 4,000; low risk; proceed with chemotherapy", "ANC = 1,240; fairly low risk; proceed with chemotherapy", "ANC = 12,400; neutrophilia; hold chemotherapy for infection workup"],
    correct: 2,
  ...
  },
  {
    ...
    choices: ["ANC = 1,800 cells/mm3; normal; no additional workup needed", "ANC = 1,500 cells/mm3; fairly low risk; outpatient management is appropriate", "ANC = 18,000 cells/mm3; neutrophilia consistent with bacterial infection", "ANC = 180 cells/mm3; high risk of infection; this represents a medical emergency (febrile neutropenia)"],
    correct: 3,
  ...
  },
  {
    ...
    choices: ["ANC = 8,000 cells/mm3; neutropenic, hold chemotherapy", "ANC = 5,200 cells/mm3; within normal range, chemotherapy can proceed", "ANC = 520 cells/mm3; high risk, hold chemotherapy", "ANC = 65 cells/mm3; critical, hold chemotherapy"],
    correct: 1,
  ...
  },
  {
    ...
    choices: ["ANC should be calculated using bands and segs (neutrophils), not lymphocytes, since ANC measures neutrophil granulocytes", "The WBC should not be converted to thousands", "The calculation should use monocytes and eosinophils instead", "ANC has no standard formula and must be measured directly"],
    correct: 0,
